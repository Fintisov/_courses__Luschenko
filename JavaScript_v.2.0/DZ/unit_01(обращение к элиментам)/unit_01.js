...
document.querySelector('.three').innerHTML =
    '<h3>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eius nam natus sunt velit veritatis voluptatem.</h3>';

// Task 11.
// Создайте пустой div c классом four. С помощью querySelector запишите внутрь div заголовок h4 с произвольным текстом и параграф p с произвольным текстом.
...
document.querySelector('.four').innerHTML +=
    '<h3>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</h3>' + '<p>Eius nam natus sunt velit veritatis voluptatem.</p>';

// Task 12.
// Создайте div с классом five. Получите его в переменную a. С помощью innerHTML запишите внутрь переменной a число 3.1415.
...
let z1 = 6;
let z2 = 3;
document.querySelector('.out1').innerHTML = z1 * z2;
...
let y1 = 6;
let y2 = 3;
document.querySelector('.out2').innerHTML = y1 / y2;
...
let x1 = 'Hello';
let x2 = 5;
document.querySelector('.out3').innerHTML = x1 + x2;
...
// Task 18.
// Создайте div.test-2. Получите его в переменную d2. Выведите эту переменную в консоль. Присвойте d2 значение 5 (d2 = 5).
...
// Task 19.
// Создайте div c классом s3 и div с классом s4. Получите div.s3 в переменную divS3. Выведите в консоль divS3.
...
// Task 20
// Получите c помощью querySelector тег body. С помощью innerHTML присвойте ему пустую строку (...innerHTML = '').
