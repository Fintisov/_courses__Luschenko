...
let inp9 = document.querySelector('.i-9'); //input
let div9 = document.querySelector('.out-9'); //див Куда выводим результат

function t9() {
    div9.innerHTML = inp9.value;
    inp9.value = '';
}
...
let inp10 = document.querySelector('.i-10'); //input
let div10 = document.querySelector('.out-10'); //див Куда выводим результат

function t10() {
div10.innerHTML = inp10.value * 10;
}

document.querySelector('.b-10').onclick = t10;

// Task 11.
// Создайте input и кнопку. По нажатию на кнопку выполняется функция, которая выводит на страницу в .out-11 число,
// которое ввел пользователь и к нему добавленное число 10.

let inp11 = document.querySelector('.i-11'); //input
let div11 = document.querySelector('.out-11'); //див Куда выводим результат

function t11() {
//    document.querySelector('.out-11').innerHTML = +document.querySelector('.i-11').value + 10;
// или
    div11.innerHTML = +inp11.value + 10;
}

document.querySelector('.b-11').onclick = t11;

// Task 12.
// Создайте два input (i-12_1 и i-12-2) и кнопку. В первый input пользователь вводит имя, во второе фамилию.
// При нажатии кнопки выполняется функция, которая выводит в .out-12 строку 'Hello имя фамилия', где имя - имя пользователя и фамилия - введенная фамилия.
let name12 = document.querySelector('.i-12_1');
let surname12 = document.querySelector('.i-12_2');
let div12 = document.querySelector('.out-12');

function t12() {
    div12.innerHTML = 'Hello' + ' ' + name12.value + ' ' + surname12.value;
}
...
// При нажатии кнопки выполняется функция, которая выводит сумму данных двух чисел на страницу в .out-13.
...
// или
        div13.innerHTML = +num1.value + +num2.value;
}
...
let num3 = document.querySelector('.i-16-1');
let num4 = document.querySelector('.i-16-2');

function t16() {
    document.querySelector('.out-16').innerHTML = +num3.value + +num4.value;
}
...
// Получите значение из input в переменную t. А затем сделайте операцию t = parseInt(t), и результат операции выведите в out-17.
// Прочитайте за эту операцию. Попробуйте по очереди вводить 44, 44aaa, 44.3, a45 . Изучите вывод.
let t1 = document.querySelector('.i-17');

function t17() {
    document.querySelector('.out-17').innerHTML = parseInt(t1.value);
}
...
function t18() {
    console.log(parseFloat(t2.value));
}
...
let num5 = document.querySelector('.i-19-1');
let num6 = document.querySelector('.i-19-2');
let div19 = document.querySelector('.out-19');

function t19() {
//   div19.innerHTML = +parseFloat(num5.value) + +parseFloat(num6.value);
//   div19.innerHTML = +parseInt(num5.value) + +parseInt(num6.value);
    div19.innerHTML = +num5.value + +num6.value;
}
...
let name = document.querySelector('.i-20-1');
let surname = document.querySelector('.i-20-2');
let age = document.querySelector('.i-20-3');
let profession = document.querySelector('.i-20-4');

let div20 = document.querySelector('.out-20');

function t20() {
div20.innerHTML = 'Уважаемый ' + name.value + ' ' + surname.value + ', ваш возраст ' + age.value + ' года, по професии вы ' + profession.value;
name.value = surname.value = age.value = profession.value = '';
}
