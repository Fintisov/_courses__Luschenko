...
function t1() {
    let out = document.querySelector('.out-1'); //переменная вывода
    let z = ''; //переменная в которую накапливаю значения
...
function t8() {
    ...
    let a = Number(document.querySelector('.i-81').value);
    let b = Number(document.querySelector('.i-82').value);
    let z = '';
    div.innerHTML = '';
...
function t9() {
    ...
    let b = Number(document.querySelector('.i-92').value);
    let z = '';
    let change;
