...
function f1() {
    ...
    return document.querySelector('.out-1').innerHTML = a1.two;
}
...
function f2() {
    ...
    return document.querySelector('.out-2').innerHTML = a2.five;
...
// Функция должна вывести в out-3 значение hi из массива a3. Возвратите это значение. Вывод - через пробел.
// Вывод, как и в предыдущем задании пишем "руками"
...
// Формат вывода - ключ пробел значение перенос строки +' <br>'.
...
function f6() {
    let a = document.querySelector('.i-61');
    let b = document.querySelector('.i-62');
...
// Функция должна получать из i-7 ключ.
...
function f8() {
    let a = document.querySelector('.i-8');
    let b = document.querySelector('.out-8');

    if (a8[a.value] !== undefined) {
        b.innerHTML = a8[a.value];
    } else {
        b.innerHTML = 0;
    }
}
...
function f9() {
    let a = document.querySelector('.i-9');
...
//  Функция должна получить значение из i-12 и удалить запись из массива a12 с таким значением.
...
// Функция должна в out-14 выводить нулевые (по индексу) элементы вложенных массивов в a14. Вывод через пробел.
...
// Task 16
// При нажатии b-16 выполняете функцию f16.
// Функция должна в out-16 выводить элементы name вложенных массивов в a16.
// Вывод через пробел.
...
// Task 17
// При нажатии b-17 выполняете функцию f17.
// Функция должна в out-17 выводить элементы name вложенных массивов в a17 для который age > 30. Вывод через пробел.
...
// Task 19
// При нажатии b-19 выполняете функцию f19.
// Функция должна в out-19 вывести цвет ветки станции которую пользователь ввел в i-19.
...
// Task 20
// При нажатии b-20 выполняете функцию f20.
// Функция должна в out-20 вывести название станции которые содержат переход на другую ветку.
