...
function t3() {
    ...
    try {
        ...
        document.querySelector(".s-3").append(newDiv);
    }
}
...
//  Task 4
// Дана переменная a. В переменную делается push.
// Используя try catch отловите ошибки если они есть.
// Если ошибка вывести в out-4 число 0.
