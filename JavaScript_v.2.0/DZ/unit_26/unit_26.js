...
function outResult(out, result) {
    return document.querySelector(`.${out}`).textContent = result;
}

function t1() {
    fetch(`${webInfo.link}?${webInfo.key}&action=1`)
        .then(response => response.text())
        .then(data => {
            outResult("out-1", data)
        })
}
...
function t2() {
    fetch(`${webInfo.link}?${webInfo.key}&action=2&name=Vadim`)
        .then(response => response.text())
        .then(data => outResult("out-2", data))
}
...
function t3() {
    fetch(`${webInfo.link}?${webInfo.key}&action=3&num1=3&num2=97`)
        .then(response => response.text())
        .then(data => outResult("out-3", data));
}
...
Не забывайте указывать параметр auth (ключ в чате).
 Выведите в out-4 результат.
  Запускаться функция должна по нажатию b-4. */

function t4() {
    fetch(`${webInfo.link}?${webInfo.key}&action=4&num1=50&num2=90`)
        .then(response => response.text())
        .then(data => outResult("out-4", data));
}
...
Не забывайте указывать параметр auth (ключ в чате).
Выведите в out-5 результат.
Запускаться функция должна по нажатию b-5. */

function t5() {
    fetch(`${webInfo.link}?${webInfo.key}&action=5`)
        .then(response => response.text())
        .then(data => outResult("out-5", data));
}
...
function t6() {
    fetch(`${webInfo.link}?${webInfo.key}&action=6&num1=56&num2=31`)
        .then(response => response.text())
        .then(data => outResult("out-6", data));
}
...
function t7() {
    fetch(`${webInfo.link}?${webInfo.key}&action=7`)
        .then(response => response.text())
        .then(data => outResult("out-7", data));
}
...
function t8() {
    fetch(`${webInfo.link}?${webInfo.key}&action=8&year=1997`)
        .then(response => response.text())
        .then(data => outResult("out-8", data));
}
...
function t9() {
    fetch(`${webInfo.link}?${webInfo.key}&action=9&m=1&d=1&y=1`)
        .then(response => response.text())
        .then(data => outResult("out-9", data));
}
...
function t10() {
    fetch(`${webInfo.link}`, {
        ...
        body: `${webInfo.key}&action=1`,
    })
        .then(response => response.text())
        .then(data => outResult("out-10", data))
}
...
function t11() {
    fetch(`${webInfo.link}`, {
        ...
        body: `${webInfo.key}&action=2&name=Vadim`,
    })
        .then(response => response.text())
        .then(data => outResult("out-11", data))
}
...
function t12() {
    fetch(`${webInfo.link}`, {
        ...
        body: `${webInfo.key}&action=3&num1=23&num2=76`,
    })
        .then(response => response.text())
        .then(data => outResult("out-12", data))
}
...
function t13() {
    fetch(`${webInfo.link}`, {
        ...
        body: `${webInfo.key}&action=4&num1=223&num2=186`,
    })
        .then(response => response.text())
        .then(data => outResult("out-13", data))
}
...
function t14() {
    fetch(`${webInfo.link}`, {
        ...
        body: `${webInfo.key}&action=5`,
    })
        .then(response => response.text())
        .then(data => outResult("out-14", data))
}
...
function t15() {
    fetch(`${webInfo.link}`, {
        ...
        body: `${webInfo.key}&action=6&num1=312&num2=87`,
    })
        .then(response => response.text())
        .then(data => outResult("out-15", data))
}
...
function t16() {
    fetch(`${webInfo.link}`, {
        ...
        body: `${webInfo.key}&action=7`,
    })
        .then(response => response.text())
        .then(data => outResult("out-16", data))
}
...
function t17() {
    fetch(`${webInfo.link}`, {
        ...
        body: `${webInfo.key}&action=8&year=1997`,
    })
        .then(response => response.text())
        .then(data => outResult("out-17", data))
}
...
function t18() {
    fetch(`${webInfo.link}`, {
        ...
        body: `${webInfo.key}&action=9&y=1`,
    })
        .then(response => response.text())
        .then(data => outResult("out-18", data))
}
