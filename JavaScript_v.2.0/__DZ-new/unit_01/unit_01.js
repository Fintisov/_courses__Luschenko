...
document.getElementById("seven").innerText = 12 * 12;
...
// Поэтому при вставке оберните данную строку одинарными кавычками. Если все сделано верно - то на странице появится картинка
...
// Присвойте out18 значение 5 (out18 = 5). Выведите переменную в консоль.
// Изучите вывод.
...
// Теперь получите в эту же переменную out19 блок div c классом out-19-test.
// Выведите переменную out19 в консоль. Изучите что изменилось.
