...
function t8() {
    let userValue = document.querySelector(".i-8").value;
    let out = document.querySelector(".out-8");

    out.textContent = userValue;
}
...
function t9() {
    let userValue = document.querySelector(".i-9");
    let out = document.querySelector(".out-9");

    out.textContent = userValue.value;
    userValue.value = "";
}
...
function t10() {
    let userValue = document.querySelector(".i-10").value;
    let out = document.querySelector(".out-10");

    out.textContent = +userValue * 20;
}

document.querySelector(".b-10").addEventListener("click", t10);

// Task 11.
// По нажатию на кнопку .b-11 выполняется функция t11, которая выводит на страницу
// в .out-11 число, которое ввел пользователь в i-11 и к нему добавленное число 55.
// В этой задаче мы не приводим к числу полученное из input.

function t11() {
    let userValue = document.querySelector(".i-11").value;
    let out = document.querySelector(".out-11");

    out.textContent = userValue + 55;
}
...
// Функция должна получить данные из input i.12-1 и i.12-2 (пользователь вводин в них фамилию и имя).
...
function t12() {
    ...
    out.textContent = `Hello ${userName} ${userSurname}`;
}
...
// После чего в .out-13 выводит их сумму.
...
function t16() {
    let a1 = document.querySelector(".i-16-1").value;
    let a2 = document.querySelector(".i-16-2").value;
    let out = document.querySelector(".out-16");

   return out.textContent = a1 + a2;
}

document.querySelector(".b-16").addEventListener("click", t16);

// Task 17.
// По нажатию на кнопку .b-17 выполняется функция t17. Функция получает из .i-17 число. И
// зучите работу кода и запомните отличия. Попробуйте ввести числа 5, 4zz, zz4, -200, 33.05
...
function t18() {
    let sum = document.querySelector(".i-18").value;
    let out = document.querySelector(".out-18");

    return out.textContent = parseFloat(sum);
}

document.querySelector('.b-18').onclick = t18;

// Task 19.
// По нажатию кнопки .b-19 функция t19 должна в out-19 вывести сумму
// двух отрицательных чисел из input .i-19-1 и .i-19-2.

function t19() {
    let a1 = +document.querySelector(".i-19-1").value;
    let a2 = +document.querySelector(".i-19-2").value;

    let out = document.querySelector(".out-19");

    out.textContent = a1 + a2;
}
