...
function f3() {
    ...
    if (i1 > i2) {
        return out.textContent = i1;
    } else {
        return out.textContent = i2;
    }
...
function f7() {
    ...
    // out.textContent = i71 ** i72;
    out.textContent = Math.pow(i71, i72);
}
...
// Функция должна получить выбранное в select число,
// потом с помощью switch case сравнить его поочередно с 1, 2, 3.
// И если число выбрано - 1, то вывести в .out-8 строку one, если 2 - two, если 3 - three.
// Напоминаю - это программирование. Как указано в задании - так и выводим.
// Т.е. Three с большой буквы - ошибка!!!
...
function f13() {
    let i13 = document.querySelector(".i-130").value;
    let out = document.querySelector(".out-13");

    out.innerHTML = typeof (i13);
}
...
// Task 14
// Дан input .i-141 и .i-142, type=number.
// Дан select .s-143, который содержит две операции - +, -, *, / .
