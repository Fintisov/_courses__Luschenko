...
function f4() {
    let myChecked = checkBox4.checked;

    if (myChecked) {
        out4.textContent = myChecked;
    } else {
        out4.textContent = myChecked;
    }
}
...
// Функция проверяет состояние .i-5 и если он checked - выводит value данного элемента, если не выбран - false.
// Вывод везде в задачах, где не указано другое, осуществляется в div.out-номер задачи.
...
function f5() {
    let myChecked = checkBox5.checked;

    if (myChecked) {
        out5.textContent = checkBox5.value;
    } else {
        out5.textContent = myChecked;
    }
}
...
let myInput6 = document.querySelector(".i-6");
let out6 = document.querySelector(".out-6");

function f6() {
    out6.textContent = myInput6.value;
}
...
// Для подсчета количества символов в строке используйте length.

let myInput7 = document.querySelector(".i-7");
let out71 = document.querySelector(".out-71");
let out72 = document.querySelector(".out-72");

function f7() {
    out71.textContent = myInput7.value;

    if (myInput7.value.length >= 6) {
        out72.textContent = 1;
    } else {
        out72.textContent = 0;
    }
...
// Task 8.
// При нажатии кнопки .b-8 запускается функция f8.
// Функция с помощью innerHTML создает в .out-8 новый div с классом "js2" и текстом "new div".
...
// Task 9
// При нажатии кнопки .b-9 запускаем функцию f9.
// Функция проверяет checked элемента .r-9.
// Если элемент выбран (checked) то выводит в .out-9 value radiobutton.
// Если не выбран - выводит false.
...
// Task 10
// При нажатии кнопки .b-10 запускаем функцию f10.
// Функция получает из .i-10 значение цвета и окрашивает style.background элемента .out-10 в этот цвет.
let color10 = document.querySelector(".i-10");
let out10 = document.querySelector(".out-10");

function f10() {
    out10.style.backgroundColor = color10.value;
}
...
// Task 11
// При нажатии кнопки .b-11 запускается функция f11.
// Функция получает цвет из .i-111 и присваивает как value элементу .i-112.
// Т.е. после нажатия кнопки выбранный цвета в первом и втором input станут одинаковые.

let color111 = document.querySelector(".i-111");
let color112 = document.querySelector(".i-112");
...
function f13() {
    out13.textContent = range13.value;
}

range13.addEventListener("input", f13);
...
function f14() {
    out14.textContent = textarea14.value;
}
...
function f15() {
    textarea15.textContent = text15.value;
    out15.textContent = text15.value;
}
...
let text18 = document.querySelector(".i-18");

function f18() {
    text18.value = select18.value;
}
...
let text19 = document.querySelector(".i-19");

function f19() {
    text19.value = out19.textContent;
}
...
let select201 = document.querySelector(".s-201");
let select202 = document.querySelector(".s-202");
