...
function t6() {
    let number6 = +document.querySelector(".i-6").value;
    let counter = "";
...
function t7() {
    let number7 = +document.querySelector(".i-7").value;
    let counter = "";
...
function t11() {
    ...
    for (let i = 0; i < divs.length; i++) {
        counter += `${divs[i].innerHTML}_`;
    }

    out11.textContent = counter;
}
