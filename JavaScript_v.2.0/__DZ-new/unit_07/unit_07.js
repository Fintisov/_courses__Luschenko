...
document.querySelector('.b-4').onclick = function () {
    document.querySelector('.out-4').textContent = t4(1997);
}
...
// Длину (число символов) можно посчитать используя свойство .length.
...
document.querySelector('.b-5').onclick = function () {
    document.querySelector('.out-5').textContent = t5('Vadimka');
}
...
// и возвращает результат с очищенными пробелами в начале и вконце строки.
