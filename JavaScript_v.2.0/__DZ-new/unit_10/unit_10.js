...
// Task 4
//Создайте массив ar4. Выведите нулевой, третий,
// восьмой элемент массива в out-4 через пробел.
...
// Task 7
// Добавьте в массив ar7 значения 'vietnam' с индексом 7 ,
// 'turkey' с индексом 6, 'italy' с индексом 5. Добавление элементов сделайте в f7.
// Выведите массив на страницу в .out-7. Разделитель - пробел.
// Обращаю ваше внимание! Это программирование.
...
function f16() {
    ...
    for (let i = 0; i < ar16.length; i++) {
        if (ar16[i] % 2) {
            ar16_odd[counterOdd] = ar16[i];
            counterOdd++;
        } else {
            ar16_even[counterEven] = ar16[i];
            counterEven++;
        }
    }
