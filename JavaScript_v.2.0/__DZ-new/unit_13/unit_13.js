...
// Давайте напишем функцию f5, которая
// принимает массив как параметр и выводит его в формате указанном в функции в указанный блок (как второй параметр).
...
// После этого вывести массив в out-11.
// Для вывода используйте функцию f5.
...
//  После этого вывести массив в out-12.
//  Для вывода используйте функцию f5.

let a12 = {
    "b": 17, "e": 22, "j": 17, "k": 22, "d": 17,
};
...
// Функция должна в out-14 выводить нулевые (по индексу)
...
// Task 15
// При нажатии b-15 выполняете функцию f15. Функция должна в out-15 выводить элементы вложенных массивов в a15.
// Вывод через пробел.
...
function f18() {
    ...
    document.querySelector(".out-18").innerHTML = branch;
}
...
function f19() {
    ...
    for (let key in a19) {
        a19[key] = a19[key].map((item) => {
            return item.toLowerCase()
        });
    }

    for (let key in a19) {
        if (a19[key].includes(i19)) {
            out = key;
            break;
        }
    }
