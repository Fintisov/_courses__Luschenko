...
// Функция считывает значение из i-1 и с помощью indexOf и ищет данный элемент в массиве a1.
...
// Функция считывает значение из i-2 и с помощью indexOf и ищет данный элемент в массиве a2.
...
const f2 = () => {
    ...
    let result = (a2.indexOf(+i2) !== -1) ? a2.indexOf(+i2) : false;
...
// Функция считывает значение из i-3 и с помощью indexOf и ищет данный элемент в массиве a3.
...
const f3 = () => {
    ...
    let result = (a3.indexOf(+i3) !== -1) ? true : false;
...
// Функция принимает 2 параметра, первый - массив, второй элемент.
// Функция должна с помощью indexOf найти и вывести в out-4
// индекс искомого элемента в массиве a4 или -1 если элемента в массиве нет.
...
// Функция считывает значение из i-5-1 и индекс с которого начинается поиск в массиве
// с i-5-2 и с помощью indexOf и ищет данный элемент в массиве a5 c позиции указанной в i-5-2.
...
const f5 = () => {
    const item = document.querySelector(".i-5-1").value;
    const from = document.querySelector(".i-5-2").value;

    let result = a5.indexOf(+item, from)
...
// Функция должна получить число из i-8 и с помощью цикла и indexOf найти все индексы данного числа в массиве a8.
// Индексы должны быть добавлены в res08. Результат (res08) выведите в out-8.
// Если число не встречается в массиве, то res08 должен быть пустым.
...
// Функция должна получить число из i-9 и с помощью цикла и indexOf
// вывести в out-9 все индексы вложенных в a9 массивов содержащие указанное число.
...
// a [6, 7, 5] под индексом 3 пример 2.
// Если a9 = [ [1,2] , [2, 3], [3,4,5], [6, 7, 5] ]
...
const f9 = () => {
    const item = +document.querySelector(".i-9").value;

    let result = "";
    for (let i = 0; i < a9.length; i++) {
        if (a9[i].indexOf(item) !== -1) {
            result += `${i} `;
        }
    }
