...
// Функция считывает значение из i-1 и с помощью push добавляет полученную из input строку в массив a1.
...
// Функция считывает значение из i-3 и с помощью push добавляет значение в массив a3.
...
// Функция считывает значение из i-5 и добавляет это значение в конец массива a5.
// Обратите внимание, в данном задании запрещено использовать push,
// мы должны выполнить присвоение через явное указание индекса последнего элемента + 1.
// В этом нам поможет знание длины массива a5.
// Таким образом, мы выполняем частичную эмуляцию метода push.
// После добавления массив выводится в консоль.
...
// Функция применяет метод pop к массиву a7 и выводит массив в консоль.
...
// Функция должна применить pop к массиву a8 и возвратить результат данной операции.
// Нажимая кнопку удалите все элементы.
// Изучите что возвращает операция когда есть элементы доступные для удаления и когда массив пуст.
...
// Напишем функцию, которая эмулирует работу pop - удаляет последний элемент массива a10 и возвращает удаленный элемент.

const a10 = [67, '55', 2, 5, '4', '8', 8, '66', '54', 11];

const f10 = () => {
    let result = (a10.length > 0) ? a10[a10.length - 1] : a10;
    if (a10.length > 0) {
