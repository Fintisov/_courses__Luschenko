...
// Функция считывает значение из i-1 и с помощью unShift добавляет полученную из input строку в массив a1.
...
// С помощью unShift число и его третью степень (куб) добавляются в массив a2.
// Обратите внимание, что добавление двух чисел нужно выполнить с помощью одного unShift.
...
// Функция считывает значение из i-3 и с помощью unShift добавляет значение в массив a3.
// Изучите вывод в консоль.
// Разберитесь, что возвращает метод unShift.
...
// Выводит a4 в консоль. Изучите решение.
...
// Функция применяет метод shift к массиву a7, выводит массив в консоль и возврщает новую длину массива a7.
...
// Функция должна применить slice с параметрами (1,4) к массиву a8 и вывести массив в консоль.
