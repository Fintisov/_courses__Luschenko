...
// Разделитель не указывать.
// Результат вывести в out-1.
...
// Разделитель - знак равно.
// Результат вывести в out-3.
...
// Функция должна с помощью цикла эмулировать работу метода join и
// возвратить строку из элементов массива arr разделенных символом delimiter.
...
// Один элемент - один символ.
// Результат вывести в out-6.
let s6 = 'hello';
...
// Получать из строки только 3 первых элемента.
// Один элемент - один символ.
// Результат вывести в out-7.
let s7 = 'hello';
...
// Функция должна развернуть строку.
// Поскольку reverse не работает со строками то мы должны сделать массив из строки s8,
// а потом развернуть его, а потом слепить обратно.
...
// Затем, с помощью filter удалить все символы из массива меньше l.
// Результат, через пробел вывести в out-10.
