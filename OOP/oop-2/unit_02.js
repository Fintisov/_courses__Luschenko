...
//Task 2
// Создайте наследника объекта cpu и назовите его memory (через proto).
// Да, мы будем строить магазин, который торгует и памятью.
// Поскольку мы наследуемся от cpu то все свойства останутся.
...
// Добавим свойство image в объект cpu.
...
cpu.img = "https://i2.rozetka.ua/goods/1865699/copy_amd_fx_series_fx_9590_fd9590fhhkwof_58abf05e14fdc_58abfc46c2b65_58abff06c94bd_images_1865699744.jpg";
memory.img = "https://i2.rozetka.ua/goods/17090881/189441988_images_17090881613.jpg";
...
cpu.sale = function (procent) {
    let discount = this.amount * (procent / 100);
